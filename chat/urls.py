...
urlpatterns = [
    ...
    path(
        "rooms/<uuid:slug>/upload/",
        views.AuthenticatedMediaUploadView.as_view(),
        name="room-upload",
    ),
    path(
        "rooms/<uuid:slug>/update/", views.RoomUpdateView.as_view(), name="room-update"
    ),
    path(
        "rooms/<uuid:slug>/delete/", views.RoomDeleteView.as_view(), name="room-delete"
    ),
    ...
    # ------------------------------------------------------------------
    path(
        "invite/<uuid:slug>/", views.InviteResolveView.as_view(), name="invite-resolve"
    ),
    ...
    path(
        "rooms/<str:room_name>/",
        views.RoomGetOrCreateView.as_view(),
        name="room-detail",
    ),
    path(
